# 🚀 PampaTec - Jornada do BMC ao MVP na pré-Incubação
...
### 1. Pré-requisitos
- [Google Antigravity](https://antigravity.google/) instalado no seu computador
- Conta no GitHub
...
- No Antigravity, digite: Conecte na minha conta do GitHub usando github CLI com autenticação via navegador, como colaborador deste repositório fornecido pelo PampaTe no GitHub: **https://github.com/PampaTec/NOME_DO_REPOSITORIO.git**
